...
# vendor_management_app/views.py
# vendor_management_app/views.py
from rest_framework import generics, status
from rest_framework.response import Response
from .models import Vendor, PurchaseOrder, HistoricalPerformance
from .serializers import VendorSerializer, PurchaseOrderSerializer
from django.db.models import Avg  # Add this import for Avg
...
def update_vendor_metrics(sender, instance, created, **kwargs):
    if created or instance.status == 'completed':
        # Calculate and update metrics when a new PurchaseOrder is created or its status is completed
